...
\textbf{Mitigation:} Encryption is optional and can be disabled in restricted jurisdictions. When enabled via \texttt{@git-stunts/vault}, deployments should follow legal counsel, jurisdiction-specific distribution policy, and organizational export-control requirements.
...
\textbf{Mitigation:} Use \textbf{git-stargate}\footnote{\url{https://github.com/flyingrobots/git-stargate}} to enforce serialized writes via SSH.
